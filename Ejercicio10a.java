...
/*
EJERCICIO 10:  En una tienda de descuento se efectúa una promoción en la cual se hace un descuento sobre el valor de la compra total según el
...
public class Ejercicio10a {
    ...
    public static void main(String[] args) {
        ...
        if (bolaCliente == 1) {
            pagoFinal = compra;
            System.out.println(
                    "La bola elegida no aplica ningún descuento, por lo tanto el valor de la compra es:\t" +  String.format("%.2f",pagoFinal)+" soles.");
        } else {
            if (bolaCliente == 2) {
                ...
                if (bolaCliente == 3) {
                    ...
                    ;
                    System.out.println(
                            "La bola elegida le asignó un descuento del 25%, por lo tanto el valor de la compra es:\t"
                                    +  String.format("%.2f",pagoFinal)+" soles.");
                } else {
                    if (bolaCliente == 4) {
                        ...
                        ;
                        System.out.println(
                                "La bola elegida le asignó un descuento del 50%, por lo tanto el valor de la compra es:\t"
                                        +  String.format("%.2f",pagoFinal)+" soles.");
                    } else {
                        System.out.println(
                                "¡FELICIDADES! La bola elegida le asignó un descuento del 100%, por lo tanto no realiza pago alguno por la compra.");
                    }
                }
            }
        }
